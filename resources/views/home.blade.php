        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <code id="copy">!addcom !setsr -ul=moderator $(urlfetch {{ route('home') }}/api/{{ Auth::user()->api_key }}/set/$(1))</code><br>
                    ...
                    <code id="copy">!addcom !settanksr -ul=moderator $(urlfetch {{ route('home') }}/api/{{ Auth::user()->api_key }}/set/tank/$(1))</code><br>
                    ...
                    <code id="copy">!addcom !setdpssr -ul=moderator $(urlfetch {{ route('home') }}/api/{{ Auth::user()->api_key }}/set/damage/$(1))</code><br>
                    ...
                    <code id="copy">!addcom !setsupsr -ul=moderator $(urlfetch {{ route('home') }}/api/{{ Auth::user()->api_key }}/set/support/$(1))</code><br>
